...
class fuzzer:
	...
	def fuzz(self):
		...
		for i in range(0,1000):
			...
			sproc=Process(target=self.start_debugger,args=(i,coverage_dict,X,Y,im_field,segfault_list))
	...
	def start_debugger(self,i,coverage_dict,X,Y,im_field,segfault_list):
		
		f1=open(RESULT_CSV,'a')
		...
		if self.iteration !=0:
			...
			if Y[self.iteration]>Y[self.iteration-1]:
				#print 't coverage: ',Y[self.iteration]
				#print 't-1 coverage: ',Y[self.iteration-1]
